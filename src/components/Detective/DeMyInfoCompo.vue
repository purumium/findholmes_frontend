<template>
  <div>
    ...
    <div v-if="imagePaths.businessRegistrationPath">
      ...
      <img :src="getImageUrl(imagePaths.businessRegistrationPath)" alt="Business Registration">
    </div>
    <div v-if="imagePaths.detectiveLicensePath">
      <h2>Detective License</h2>
      <img :src="getImageUrl(imagePaths.detectiveLicensePath)" alt="Detective License">
    </div>
    <div v-if="imagePaths.profilePicturePath">
      <h2>Profile Picture</h2>
      <img :src="getImageUrl(imagePaths.profilePicturePath)" alt="Profile Picture">
    </div>
    <h3>가입일 {{createdAt}}</h3>
...
const test = async () => {
      ...
      try {
        ...
        imagePaths.value.businessRegistrationPath = response.data.businessRegistration;
